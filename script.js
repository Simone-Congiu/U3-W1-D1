...
let controlResul = function () {
    let num = parseFloat(document.querySelector("#firstN").value);
    console.log(num);
    let num2 = parseFloat(document.querySelector("#secondN").value);
    console.log(num2);
    let containerNumber = document.querySelector(".containerRandomNumber");
